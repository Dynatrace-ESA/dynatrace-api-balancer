!function () {
    ...
    function g(r, e, o, s) {
        ...
        return e.forEach(function (e, n) {
            if ("heading" === e.type && e.depth <= s) {
                ...
                a && (p = a.replace(/<!-- {docsify-ignore} -->/, "").replace(/{docsify-ignore}/, "").replace(/<!-- {docsify-ignore-all} -->/, "").replace(/{docsify-ignore-all}/, "").trim()),
                l[c] = {
                    slug: c,
                    title: p,
                    body: ""
                ...
                if (0 === n && (c = o.toURL(r), l[c] = {
                            slug: c,
                            title: "/" !== r ? r.slice(1) : "Home Page",
                            body: e.text || ""
                        }), !c)
                    return;
                l[c] ? l[c].body ? (e.text = h(e), e.text = f(e), l[c].body += "\n" + (e.text || "")) : (e.text = h(e), e.text = f(e), l[c].body = l[c].body ? l[c].body + e.text : e.text) : l[c] = {
                    slug: c,
                    title: "",
                    body: ""
                }
    ...
    function r(i, r) {
        ...
        if (u = JSON.parse(localStorage.getItem(p)), c)
            u = {};
        else if (!o)
            return;
        var h = s.length,
        ...
        s.forEach(function (a) {
            return u[a] ? f++ : void Docsify.get(r.router.getFile(a), !1, r.config.requestHeaders).then(function (e) {
                ...
                h === ++f && (n = i.maxAge, t = l, e = p, localStorage.setItem(t, Date.now() + n), localStorage.setItem(e, JSON.stringify(u)))
            })
        })
    }
    var o,
    ...
    function c(e) {
        ...
        if (!e)
            return t.classList.remove("show"), a.classList.remove("show"), t.innerHTML = "", void(o.hideOtherSidebarContent && (i.classList.remove("hide"), n.classList.remove("hide")));
        var e = function (e) {
            var n = [],
            t = [];
            ...
            for (var i = 0; i < t.length; i++)
                !function (e) {
                    ...
                    d && (a.forEach(function (e) {
                            ...
                            a = d ? s.search(t) : -1,
                            i = l ? c.search(t) : -1,
                            (0 <= a || 0 <= i) && (r += 0 <= a ? 3 : 0 <= i ? 2 : 0, i < 0 && (i = 0), a = (a = n = 0) == (n = i < 11 ? 0 : i - 10) ? 70 : i + e.length + 60, l && a > l.length && (a = l.length), t = "..." + c.substring(n, a).replace(t, function (e) {
    ...
    $docsify.plugins = [].concat(function (e, n) {
        var t = Docsify.util,
        a = n.config.search || v;
        Array.isArray(a) ? v.paths = a : "object" == typeof a && (v.paths = Array.isArray(a.paths) ? a.paths : "auto", v.maxAge = (t.isPrimitive(a.maxAge) ? a : v).maxAge, v.placeholder = a.placeholder || v.placeholder, v.noData = a.noData || v.noData, v.depth = a.depth || v.depth, v.hideOtherSidebarContent = a.hideOtherSidebarContent || v.hideOtherSidebarContent, v.namespace = a.namespace || v.namespace, v.pathNamespaces = a.pathNamespaces || v.pathNamespaces);
        var i = "auto" === v.paths;
