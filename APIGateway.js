 ...
 */
function APIGateway(config, limits) {}
 ...
 */
APIGateway.prototype.getHealth = function (frequency, callback) {}

/*** START OF ACTUAL IMPLEMENTATION ***/

const APIGatewayIF = function (config, limits) {
    const self = this;
